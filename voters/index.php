            ...
            <?php 
                ...
                ?>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th colspan="4" class="bg-green text-white"><h5> POLITICAL PART: <?php echo strtoupper($election_topic); ?></h5></th>
                                </tr>
                                <tr>
                                    <th> Electrol Symbol </th>
                                    <th> Candidates </th>
                                    <th> No of Votes </th>
                                    <th> Action </th>
                                </tr>
                ...
                <?php
                    ...
                    echo "No active election available.";
                }
            ?>
