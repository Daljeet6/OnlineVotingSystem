			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="assets/images/box.gif" class="brand_logo" alt="Logo">
					</div>
				</div>
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="Voter ID" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                            ...
                            <button type="submit" name="sign_up_btn" class="btn login_btn">Register</button>
                        </div>
                            </form>
                        </div>
                ...
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="contact_no" class="form-control input_user" placeholder="Voter ID" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                                Don't have an account? <a href="?sign-up=1" class="ml-2 text-white">Register Here</a>
                            </div>
                        </div>
                <?php
                    }
